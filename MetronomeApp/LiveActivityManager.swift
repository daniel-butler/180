...
final class LiveActivityManager {
    ...
    private(set) var lastSentState: MetronomeActivityAttributes.ContentState?
    ...
    func updateActivity(bpm: Int, isPlaying: Bool) {
        ...
        lastSentState = MetronomeActivityAttributes.ContentState(bpm: bpm, isPlaying: isPlaying)
    ...
    private func observeActivityUpdates(_ activity: Activity<MetronomeActivityAttributes>) {
        contentUpdateTask?.cancel()
